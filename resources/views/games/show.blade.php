...
@section('content')
    <div class="container-xl pb-2">
        <div class="mb-4 text-center">
            <span class="tier-pill tier-pill-basic">Basic</span>
            <h1 class="h3 mb-1"><i class="bi bi-plus-circle"></i> Addition</h1>
            <p class="text-secondary mb-0">Pick your numbers, then answer as many sums as you can!</p>
        </div>
