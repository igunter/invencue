...
@section('meta_title', 'Addition — Adding Game for Kids')
@section('meta_blurb', 'A free addition game for primary school kids — pick the numbers to add, how many questions, and how much time per question.')
@section('meta_words', 'addition game, adding game for kids, maths game, primary school maths, learn addition')
...
@section('content')
    <div class="container-xl pb-2">
        @include('partials.games-header', [
            'category' => $category,
            'game' => $game,
            'blurb' => 'Pick your numbers, then answer as many sums as you can!'
        ])
            ...
            <div id="setupScreen">
                <div class="card mult-setup-card">
                    <div class="card-body p-4">
                        <h2 class="h6 text-uppercase text-secondary mb-3"><i class="bi bi-grid-3x3-gap"></i> Add which numbers?</h2>
        ...
        <div class="mult-wrap mt-5">
            <h2 class="h6 text-secondary text-uppercase mb-2">About this addition game</h2>
            <p class="text-secondary small">This free addition game helps primary school kids learn to add numbers together through quick, repeatable practice. Choose which numbers to include, set how many questions you want and how much time per question, then answer as many sums as you can before time runs out. It's a simple way to build number fluency and speed at the kitchen table, in the classroom, or on the go &mdash; no sign-up required.</p>
        </div>
    </div>
@endsection
    ...
    <script>
        (function() {
            ...
            function loadSettings() {
                try {
                    const raw = localStorage.getItem('additionGame.settings');
                    if (!raw) return;
            ...
            function saveSettings() {
                try {
                    localStorage.setItem('additionGame.settings', JSON.stringify({
            ...
            function buildQuestions(tables, count) {
                ...
                for (let i = 0; i < count; i++) {
                    ...
                    let attempts = 0;
                    do {
                        a = tableList[randInt(0, tableList.length - 1)];
                        b = randInt(1, 12);
                        key = a + '+' + b;
                        attempts++;
            ...
            function showResults() {
                ...
                if (pct >= 0.9) message = "Amazing! You're an addition superstar!";
