...
@section('meta_title', 'Multiply — Times Tables Game for Kids')
@section('meta_blurb', 'A free multiplication game for primary school kids — pick the times tables to practise, how many questions, and how much time per question.')
@section('meta_words', 'times tables game, multiplication game for kids, maths game, primary school maths, learn multiplication')
...
@section('content')
    <div class="container-xl pb-2">
        @include('partials.games-header', [
            'category' => $category,
            'game' => $game,
            'blurb' => 'Pick your times tables, then answer as many questions as you can!'
        ])
            ...
            <div id="setupScreen">
                <div class="card mult-setup-card">
                    <div class="card-body p-4">
                        <h2 class="h6 text-uppercase text-secondary mb-3"><i class="bi bi-grid-3x3-gap"></i> Which times tables?</h2>
                        ...
                        <div id="setupError" class="alert alert-warning mt-4 mb-0 d-none" role="alert">
                            Pick at least one times table to play with.
                        </div>
        ...
        <div class="mult-wrap mt-5">
            <h2 class="h6 text-secondary text-uppercase mb-2">About this multiplication game</h2>
            <p class="text-secondary small">This free times tables game gives kids fast, focused practice at multiplication facts. Choose which tables to work on, how many questions you want and how much time per question, then see how many you can answer correctly. Regular short sessions like this are one of the quickest ways to build recall of the times tables &mdash; no accounts, no ads, just practice.</p>
        </div>
    </div>
@endsection
...
@push('scripts')
    <script>
        (function() {
            ...
            function getHint() {
                return 'Multiply the two numbers together.';
            }

            function loadSettings() {
                try {
                    const raw = localStorage.getItem('multiplyGame.settings');
                    if (!raw) return;
            ...
            function saveSettings() {
                try {
                    localStorage.setItem('multiplyGame.settings', JSON.stringify({
            ...
            function showResults() {
                ...
                if (pct >= 0.9) message = "Amazing! You're a multiplication superstar!";
